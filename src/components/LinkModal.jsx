    ...
    return (
        ...
        >
           <Modal.Header closeButton>
            ...
            <Modal.Body style={{ marginTop: '10px', marginBottom: '20px' }}>
                <p>
                Now, just copy the link and share it with your special one. Don’t be shy, and wish you
                all the best.
                </p>

                <p className="text-muted small">
                    Also you can take a look from{' '}
